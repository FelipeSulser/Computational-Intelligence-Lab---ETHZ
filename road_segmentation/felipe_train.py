...
checkpoints_dir = '/Users/felipesulser/Dropbox/ETH/CIL/TensorFlow/checkpoints'
log_folder = '/Users/felipesulser/Dropbox/ETH/CIL/TensorFlow/log_folder_fcn16s'
...
fcn_32s_checkpoint_path = '/Users/felipesulser/Dropbox/ETH/CIL/TensorFlow/tf-image-segmentation/tf_image_segmentation/fcn_32s_checkpoint/model_fcn32s_final.ckpt'
...
with tf.Session()  as sess:
    ...
    for i in xrange(11127 * 10):
        ...
        if i % 11127 == 0:
            save_path = saver.save(sess, "/Users/felipesulser/Dropbox/ETH/CIL/TensorFlow/tf-image-segmentation/tf_image_segmentation/fcn_16s_checkpoint/new_model_fcn16s_final.ckpt")
